/**
 * Plants vs Zombies - Main Application
 * Built by: Anamay (Flamechargerr)
 * GitHub: https://github.com/Flamechargerr
 * 
 * Original Code by: Bhavya Chopra & Sonali Singhal
 */
package sample;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        primaryStage.setTitle("Plants VS Zombies - By Anamay (Flamechargerr)");
