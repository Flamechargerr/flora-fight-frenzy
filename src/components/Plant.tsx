...
import WallNutSVG from '../assets/plants/WallNut.svg?react';
    ...
    case 'sunflower':
      plantContent = (
        <div className="w-full h-full flex flex-col items-center justify-center">
          <SunflowerSVG style={{ width: '90%', height: '90%' }} />
        </div>
      );
      break;
    ...
    case 'peashooter':
      plantContent = (
        <div className={`w-full h-full flex flex-col items-center justify-center ${isRecoil ? 'recoil' : ''}`}>
          <PeashooterSVG style={{ width: '90%', height: '90%' }} />
        </div>
      );
      break;
    ...
    case 'wallnut':
      plantContent = (
        <div className="w-full h-full flex items-center justify-center">
          <WallNutSVG style={{ width: '90%', height: '90%' }} />
        </div>
      );
      break;
