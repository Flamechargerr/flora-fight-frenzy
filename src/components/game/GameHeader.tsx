...
const GameHeader: React.FC<GameHeaderProps> = ({
  ...
  if (isMobile) {
    return (
      <div className="pvz-game-interface glass mb-2 p-3 rounded-xl">
        ...
        <div className="flex items-center justify-between mb-2">
          <div className="bg-garden-light/50 px-3 py-2 rounded-lg flex items-center">
            ...
            <span className="pvz-text font-bold text-sm">{sunAmount}</span>
          </div>
          
          <div className="bg-garden-light/50 px-3 py-2 rounded-lg text-center">
            <span className="pvz-text text-xs font-semibold">Wave {currentWave}/5</span>
          </div>
          
          <div className="bg-garden-light/50 px-3 py-2 rounded-lg">
            <span className="pvz-text font-bold text-xs">L{level}</span>
          </div>
        </div>
        
        {/* Wave progress bar */}
        <div className="flex items-center gap-2">
          <span className="pvz-text text-xs text-gray-600">Progress:</span>
          ...
          <span className="pvz-text text-xs font-bold text-gray-700">{score}</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="pvz-game-interface glass mb-4 p-3 rounded-xl flex items-center justify-between">
      <div className="flex items-center">
        <div className="bg-garden-light/50 px-4 py-2 rounded-lg flex items-center mr-4">
          ...
          <span className="pvz-text font-bold">{sunAmount}</span>
        </div>
        
        <div className="bg-garden-light/50 px-4 py-2 rounded-lg">
          <span className="pvz-text text-sm">Wave {currentWave}/5</span>
      ...
      <div className="flex items-center gap-3">
        <div className="bg-garden-light/50 px-4 py-2 rounded-lg">
          <span className="pvz-text font-bold">Level: {level}</span>
        </div>
        <div className="bg-garden-light/50 px-4 py-2 rounded-lg">
          <span className="pvz-text font-bold">Score: {score}</span>
        </div>
      </div>
    </div>
  );
